...
def cache_acquisition(target_nodes,timestamp,excluded_nodes):
    ...
    path = 'results/attackcost/0715/cache_info/' + str(timestamp) + ".log"
...
if __name__ == "__main__":
    if "--loop" in sys.argv:
        while True:
            ...
            addrs_count,resp_count,all_count = cache_acquisition(target_nodes,starttime.timestamp(),excluded_nodes)
            print(addrs_count)
            print(resp_count)
